...
export type NonRUltimateOrdersRecord<
  Tdark = unknown,
  Tdark_shorts = unknown,
  Twhite = unknown,
> = {
  dark?: null | Tdark
...
export type CartSizeResponse<
  TsumQuantity = unknown,
  Texpand = unknown,
> = Required<CartSizeRecord<TsumQuantity>> & BaseSystemFields<Texpand>
export type ColorResponse<Texpand = unknown> = Required<ColorRecord> &
  BaseSystemFields<Texpand>
export type DiscountCodesResponse<Texpand = unknown> =
  Required<DiscountCodesRecord> & BaseSystemFields<Texpand>
export type GameResponse<Texpand = unknown> = Required<GameRecord> &
  BaseSystemFields<Texpand>
export type GamePointResponse<Texpand = unknown> = Required<GamePointRecord> &
  BaseSystemFields<Texpand>
export type GamePointEventResponse<Texpand = unknown> =
  Required<GamePointEventRecord> & BaseSystemFields<Texpand>
export type LineItemResponse<Tfields = unknown, Texpand = unknown> = Required<
  LineItemRecord<Tfields>
> &
  BaseSystemFields<Texpand>
export type NonRUltimateOrdersResponse<
  Tdark = unknown,
  Tdark_shorts = unknown,
  Twhite = unknown,
  Texpand = unknown,
> = Required<NonRUltimateOrdersRecord<Tdark, Tdark_shorts, Twhite>> &
  BaseSystemFields<Texpand>
export type OrderResponse<
  TshippingAddress = unknown,
  Texpand = unknown,
> = Required<OrderRecord<TshippingAddress>> & BaseSystemFields<Texpand>
export type OrderLineItemResponse<
  Tfields = unknown,
  Texpand = unknown,
> = Required<OrderLineItemRecord<Tfields>> & BaseSystemFields<Texpand>
export type PlayerResponse<Texpand = unknown> = Required<PlayerRecord> &
  BaseSystemFields<Texpand>
export type ProductResponse<Texpand = unknown> = Required<ProductRecord> &
  BaseSystemFields<Texpand>
export type ProductFieldResponse<
  TpriceIncreaseArray = unknown,
  Texpand = unknown,
> = Required<ProductFieldRecord<TpriceIncreaseArray>> &
  BaseSystemFields<Texpand>
export type StoreSectionResponse<Texpand = unknown> =
  Required<StoreSectionRecord> & BaseSystemFields<Texpand>
export type TeamResponse<Texpand = unknown> = Required<TeamRecord> &
  BaseSystemFields<Texpand>
export type TeamGroupResponse<Texpand = unknown> = Required<TeamGroupRecord> &
  BaseSystemFields<Texpand>
export type TournamentResponse<Texpand = unknown> = Required<TournamentRecord> &
  BaseSystemFields<Texpand>
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> &
  AuthSystemFields<Texpand>
export type VendorOrderResponse<Texpand = unknown> =
  Required<VendorOrderRecord> & BaseSystemFields<Texpand>
...
export type TypedPocketBase = PocketBase & {
  ...
  collection(
    idOrName: 'game_point_event',
  ): RecordService<GamePointEventResponse>
  collection(idOrName: 'line_item'): RecordService<LineItemResponse>
  collection(
    idOrName: 'non_r_ultimate_orders',
  ): RecordService<NonRUltimateOrdersResponse>
