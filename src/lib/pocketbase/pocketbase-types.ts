...
export type OrderRecord<Tevents = unknown, TshippingAddress = unknown> = {
	discountCode?: string
	events?: null | Tevents
...
export type OrderResponse<Tevents = unknown, TshippingAddress = unknown, Texpand = unknown> = Required<OrderRecord<Tevents, TshippingAddress>> & BaseSystemFields<Texpand>
